					...
					<table height="80" align="center" cellpadding="0"
						...
						<tr>
							<td
								...
								colspan="12" align="center" bordercolor="#FFFFFF"><b>${fb:normtypetoname(type)}明细查询</b>
							</td>
						</tr>
						<tr>
						...
						<tr height="50px" class="表格表头背景1" id="hang">
							...
							<c:forEach items="${list}" var="norm" varStatus="status">
							...
							<div align="center">
								<a	href="<%=path%>/normquery.action?level=${level}&currentPage=${previousPage}&type=${type}"
							style="padding-right: 30px;color: #104E8B">上一页</a> 
									${currentPage} of ${totalPages}
								<a	href="<%=path%>/normquery.action?level=${level}&currentPage=${nextPage}&type=${type}"
							style="padding-right: 30px;color: #104E8B">下一页</a> 	
									共有 ${totalRows} 条记录
								</div></td>
							<td>
							 <input type="button" value="添加新指标" onclick="location='<%=path%>/beforenormadd.action?type=${type}'"/>	
							</td>
						</tr>
		</table>
		</form>
