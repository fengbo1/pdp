...
<style type="text/css">
 ...
 span{
	...
	<body>
		<form action="<%=path%>/normupdate.action" method="post">
    		 ...
    		 <tr>
    			...
    			<td width="300" class="as">
    				<input style="width:500px"  type="text" id="name" name="name" value="${norm.name}"/>     				
    			</td>
    		</tr>
    		<!-- 
    		 <tr>
    	 ...
    	 -->
    		 <tr>
    			...
    			<td width="300" class="as">
    				<textarea id="target" name="target" rows="20" cols="30" >${norm.target}</textarea>
    			</td>
    		 ...
    		 <tr>
    			...
    			<td width="300" class="as">
    				<input style="width:500px"  type="text" id="score" name="score" value="${norm.score}" onkeyup="this.value=value.replace(/[^\d.]/g,'')"  onafterpaste="this.value=value.replace(/[^\d.]/g,'')"/> 
    			</td>
    		</tr>
    	   ...
    	   <tr>
    			...
    			<td width="300" class="as">
    				<textarea id="rule" name="rule" rows="10" cols="30" >${norm.rule}</textarea>
    			</td>
    		</tr>
    		<tr>
    			<td width="100" class="as" >
    			...
    			<td width="300" class="as">
    				<input style="width:500px"  type="text" id="remark" name="remark"  value="${norm.remark}"/>     				
    			</td>
    		</tr>
