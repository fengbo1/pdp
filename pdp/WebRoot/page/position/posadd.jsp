...
<style type="text/css">
 ...
 span{
	...
	<body>
		<form action="<%=path%>/posadd.action" method="post">
    	    ...
    	    <tr>
    			<td width="200" class="as" >
    				<span style="font-size:12pt;color:black">关键业务指标权重</span><span>*</span>
    			</td>
    			<td width="300" class="as">
    				<input style="width:280px"  type="text" id="propa" name="propa" onkeyup="this.value=value.replace(/[^\d.]/g,'')"  onafterpaste="this.value=value.replace(/[^\d.]/g,'')"/> 
    		 ...
    		 <tr>
    			<td width="200" class="as" >
    				<span style="font-size:12pt;color:black">关键任务指标权重</span><span>*</span>
    			</td>
    			<td width="300" class="as">
    				<input style="width:280px"  type="text" id="propb" name="propb" onkeyup="this.value=value.replace(/[^\d.]/g,'')"  onafterpaste="this.value=value.replace(/[^\d.]/g,'')"/> 
    		 ...
    		 <tr>
    			<td width="200" class="as" >
    				<span style="font-size:12pt;color:black">品能目标权重</span><span>*</span>
    			</td>
    			<td width="300" class="as">
    				<input style="width:280px"  type="text" id="propc" name="propc" onkeyup="this.value=value.replace(/[^\d.]/g,'')"  onafterpaste="this.value=value.replace(/[^\d.]/g,'')"/> 
