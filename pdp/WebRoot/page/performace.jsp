				...
				<div>
					...
					<div style="margin-top: 5px; background-color: #188AE7;">
						<ul class="expmenu">
							<li class="a">
								<div class="header">
									<span class="label">绩效得分查询</span>
								</div>
								<ul class="menu1">
								  <c:if test="${(zhis!='0')&&(zhis!='1')&&(zhis!='2')&&(zhis!='3')}">
									<li class="cc"  onclick="frame('seasonquery_person')">个人绩效得分查询</li>
									</c:if>
									<c:if test="${zhis=='2'||zhis=='3'}">
									<li class="cc"  onclick="frame('seasonquery_office')">处室员工绩效得分查询</li>
									</c:if>
									<c:if test="${zhis=='0'||zhis=='1'||authoR=='R'}">
							 ...
							 <c:if test="${(canscores=='1'||authoR=='R')&&newnumber!='85335130'}">
							<li class="a">
								<div class="header">
									<span class="label">绩效评价打分</span>
								</div>
								<ul class="menu1">
								    <c:if test="${canscores=='1'}">
									<li class="cc"  onclick="frame('seasonrate')">季度评分</li>
									</c:if>
									<c:if test="${authoR=='R'&&newnumber!='93526888'}">
									<li class="cc"  onclick="frame('rate_set')">评分设置</li>
									</c:if>
								</ul>
							</li>
							</c:if>
							...
							<li class="a">
								...
								<ul class="menu1">
								<c:if test="${authoR=='R'}">
									<li class="cc"  onclick="frame('kpilist')">关键业绩指标KPI管理</li>
									<li class="cc"  onclick="frame('ktilist')">关键任务指标KTI管理</li>
									<li class="cc"  onclick="frame('kbilist')">关键行为指标KBI管理</li>
									<li class="cc"  onclick="frame('kcilist')">关键胜任力指标KCI管理</li>
								</c:if>
								<c:if test="${zhis=='0'||zhis=='1'}">
									<li class="cc"  onclick="frame('kpilistquery')">关键业绩指标KPI</li>
									<li class="cc"  onclick="frame('ktilistquery')">关键任务指标KTI</li>
									<li class="cc"  onclick="frame('kbilistquery')">关键行为指标KBI</li>
									<li class="cc"  onclick="frame('kcilistquery')">关键胜任力指标KCI</li>
								</c:if>
								</ul>
							</li>
							</c:if>
						<c:if test="${zhis=='0'||zhis=='1'||authoR=='R'||zhis=='2'||zhis=='3'}">
							<li class="a">
								<div class="header">
